...
import 'package:flutterquizapp/widgets/custom_text.dart';
import 'package:flutterquizapp/models/question.dart';
    ...
    return showDialog(
      ...
      builder: (BuildContext context) {
        return new SimpleDialog(
          title: new CustomText(bonneReponse ? "C'est gagné ! " : "Oups perdu...", color: (bonneReponse) ? Colors.green: Colors.red,),
